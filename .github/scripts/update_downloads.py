...
def main():
    ...
    badge_html = f'<a href="https://marketplace.dify.ai/?q=bdim&category=all"><img src="{badge_url}" alt="Total Downloads" /></a>'

    pattern = r'<a href="https://marketplace\.dify\.ai/\?q=bdim&category=all"><img src="https://img\.shields\.io/badge/Total_Downloads-\d+-[^"]*" alt="Total Downloads" /></a>'
